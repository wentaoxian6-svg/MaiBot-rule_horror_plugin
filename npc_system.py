...
class BehaviorNode:
    ...
    def evaluate(self, npc: 'NPC', game_state: Dict) -> bool:
        """评估节点是否可以执行"""
    ...
    def execute(self, npc: 'NPC', game_state: Dict) -> Dict[str, any]:
        """执行节点动作"""
        result = {
...
class NPCMemory:
    ...
    def __init__(self):
        self.player_interactions: Dict[str, List[Dict]] = {}
        self.player_locations: Dict[str, List[Dict]] = {}
        ...
        self.last_seen_time: Dict[str, Optional[int]] = {}
        self.last_seen_location: Dict[str, Optional[str]] = {}
        self.total_interactions: int = 0
    
    def record_interaction(self, player_id: str, interaction_type: str, details: Dict, game_time: int):
        """记录与玩家的互动"""
    ...
    def get_recent_interactions(self, player_id: str, count: int = 5) -> List[Dict]:
        """获取最近的互动记录"""
...
class NPC:
    ...
    def _should_investigate(self, npc: 'NPC', game_state: Dict) -> bool:
        """判断是否应该调查"""
    ...
    def _should_escape(self, npc: 'NPC', game_state: Dict) -> bool:
        """判断是否应该逃跑"""
        for player_id, fear_level in self.memory.player_fear_levels.items():
            if fear_level > 0.7:
                return True
        return False
    
    def _should_attack(self, npc: 'NPC', game_state: Dict) -> bool:
        """判断是否应该攻击"""
        for player_id, attitude in self.memory.player_attitudes.items():
            if attitude == NPCAttitude.HOSTILE:
                return True
        return False
    
    def _should_interact(self, npc: 'NPC', game_state: Dict) -> bool:
        """判断是否应该互动"""
    ...
    def _investigate_sound(self, npc: 'NPC', game_state: Dict) -> Dict:
        """调查声音"""
        sounds = game_state.get("recent_sounds", [])
        if not sounds:
    ...
    def _escape_to_safety(self, npc: 'NPC', game_state: Dict) -> Dict:
        """逃往安全地点"""
    ...
    def _attack_player(self, npc: 'NPC', game_state: Dict) -> Dict:
        """攻击玩家"""
        hostile_players = [
    ...
    def _interact_with_player(self, npc: 'NPC', game_state: Dict) -> Dict:
        """与玩家互动"""
        players = game_state.get("players", {})
        nearby_players = [
    ...
    def _patrol(self, npc: 'NPC', game_state: Dict) -> Dict:
        """巡逻"""
    ...
    def update(self, game_state: Dict, game_time: int) -> Dict[str, any]:
        """更新NPC状态"""
