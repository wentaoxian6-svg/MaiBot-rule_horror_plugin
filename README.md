...
5. 我用claude-opus-4.5玩，效果非常好，强推！（不建议用思考模型玩，生成内容的时间太长了）
6. **提醒**：多人模式中，每个参与玩家的个人身份、规则、身份独有信息通过私聊发送，需要确保每个参与玩家都有麦麦的好友，否则将接收不到自己的个人身份及身份独有信息。出于游戏性的考虑，多人模式游玩时不设置可在群聊中查阅的个人身份及身份独有信息，使用 `/rg 身份` 指令也仍然通过私聊发送。（在群里还是可以查看自己的规则）
